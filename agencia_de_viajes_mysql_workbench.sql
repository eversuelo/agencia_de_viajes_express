CREATE DATABASE  IF NOT EXISTS `agencia_de_viajes` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `agencia_de_viajes`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: agencia_de_viajes
-- ------------------------------------------------------
...
INSERT INTO `testimoniales` VALUES (1,'Hola Mundo','correo@corre.com','ksjsdkjksdlfjsldfsdfsd'),(2,'Hola Mundo','correo@corre.com','ksjsdkjksdlfjsldfsdfsd');
...
--
-- Dumping events for database 'agencia_de_viajes'
--

--
-- Dumping routines for database 'agencia_de_viajes'
--
...
-- Dump completed on 2022-08-21 22:38:33
